...
<head>
    ...
    <title>MUGISHA Fred Hotel</title>
    <style>
        :root {
            --bg: #eef7ff;
            --bg-soft: #f7fbff;
...
<body>
        ...
        <div class="container">
            <div class="hero-panel">
                <div class="hero-copy">
                    ...
                    <h1>Welcome to MUGISHA Fred Hotel</h1>
                    <p>Have enjoyment with our service, meals, and a warm atmosphere designed to turn every visit into a memorable experience!.</p>
    ...
    <div class="container">
        ...
        <div class="section about-card" id="about">
            <h2>About Us</h2>
            <p>Providing good service and memorable events is our destiny.
            </p>
        </div>
        ...
        <div class="section menu-card" id="menu">
            ...
            <table>
                ...
                <tr><td>spagghet meals</td><td>FRW5000</td></tr>
                <tr><td>chicken burger</td><td>FRW5000</td></tr>
                <tr><td>Omolleti</td><td>FRW 3000</td></tr>
